...
Pracownik::Pracownik() : pesel(""), imie(""), nazwisko(""), login(""), haslo(""), pensja(0.0), funkcja("") {} //konstruktor z wartoœciami domyœlnymi
...
//funkcjê zwracaj¹ce dan¹ wartoœæ
...
void Pracownik::wypozyczKsiazke(BazaKsiazek& bazaKsiazek, BazaCzytelnikow& bazaCzytelnikow, int egzemplarzID, const KontoCzytelnika& czytelnik) {
    if (!bazaCzytelnikow.czyMoznaWypozyczyc(czytelnik)) { 
        return; //wyjœcie z funckji, jeœli wypo¿yczenie jest niemo¿liwe
    }
